...
/*   Updated: 2024/12/06 10:00:51 by cofische         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    door->timer = 0.0f;      // Initially closed
    door->state = CLOSE;         // Closed state
    door->open_time.tv_sec = 0;
    door->open_time.tv_usec = 0;
	door->last_update.tv_sec = 0;
}
